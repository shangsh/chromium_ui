...
namespace base
{
    ...
    {
        size_type ret = __min(length_-pos, n);
    ...
    size_type StringPiece::rfind(const StringPiece& s, size_type pos) const
    {
        ...
        if(s.empty())
        {
            return __min(length_, pos);
        }

        const char* last = ptr_ + __min(length_-s.length_, pos) + s.length_;
    ...
    size_type StringPiece::rfind(char c, size_type pos) const
    {
        ...
        for(size_type i=__min(pos, length_-1); ; --i)
        {
            if(ptr_[i] == c)
            {
                return i;
        ...
        size_type pos) const
    {
        ...
        size_type i = __min(pos, length_-1);
        if(s.length_ == 0)
        {
            return i;
        }
