...
namespace view
{
    ...
    public:
        ...
        {
            max_ascent_ = __max(ascent, max_ascent_);
            max_descent_ = __max(descent, max_descent_);
        ...
        gfx::Size* pref)
    {
        ...
        {
            (*i)->CalculateSize();
            pref->set_width(__max(pref->width(), (*i)->LayoutWidth()));
        }
    ...
    void GridLayout::AddViewState(ViewState* view_state)
    {
        ...
        remaining_row_span_ = __max(remaining_row_span_, view_state->row_span);
...
view::GridLayout* CreatePanelGridLayout(view::View* host)
{
    view::GridLayout* layout = new view::GridLayout(host);
