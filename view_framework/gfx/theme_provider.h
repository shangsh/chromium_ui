...
#ifndef __theme_provider_h__
#define __theme_provider_h__
...
public:
    ...
    virtual gfx::Bitmap GetBitmapNamed(int id) const = 0;

    // Get the color specified by |id|.
    virtual gfx::Color GetColor(int id) const = 0;
