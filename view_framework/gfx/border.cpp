...
namespace view
{
    ...
    namespace
    {
        ...
        {
        public:
            SolidBorder(int thickness, const gfx::Color& color);
        ...
        SolidBorder::SolidBorder(int thickness, const gfx::Color& color)
    ...
    // static
    Border* Border::CreateSolidBorder(int thickness, const gfx::Color& color)
    {
