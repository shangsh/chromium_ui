...
#ifndef __window_win_h__
#define __window_win_h__
...
namespace view
{
    ...
    //
    ///////////////////////////////////////////////////////////////////////////////
    class WindowWin : public WidgetWin, public Window
    {
    public:
        virtual ~WindowWin();
    ...
    protected:
        ...
        virtual void OnNCLButtonDown(UINT ht_component, const gfx::Point& point);
        virtual void OnNCRButtonDown(UINT ht_component, const gfx::Point& point);
        virtual void OnRButtonUp(UINT ht_component, const gfx::Point& point);
    ...
    private:
        ...
        void ProcessNCMousePress(const gfx::Point& point, int flags);
