...
namespace view
{
    ...
    public:
        ...
        static RootView* FindRootView(HWND native_window);

        // Returns list of all root views for the native window and its
        // children.
        static void FindAllRootViews(HWND native_window,
        ...
        static Widget* GetWidgetFromNativeView(HWND native_view);
        static Widget* GetWidgetFromNativeWindow(HWND native_window);
        ...
        virtual void Init(HWND parent, const gfx::Rect& bounds) = 0;

        // Initialize the widget with a views::Widget parent and an initial
        // desired size.  This internally invokes |Init(HWND,
        ...
        virtual bool ContainsNativeView(HWND native_view) = 0;
    };
